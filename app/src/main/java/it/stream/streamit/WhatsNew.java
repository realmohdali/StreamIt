...
public class WhatsNew extends AppCompatActivity {
    ...
    private static final String URL = "http://realmohdali.000webhostapp.com/streamIt/php_modules/whatsNew.php";
    ...
    private void loadActivity() {
        ...
        mRecyclerView = findViewById(R.id.recentView);
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                switch (newState) {
                    ...
                    case BottomSheetBehavior.STATE_COLLAPSED:
                        getSupportActionBar().setTitle(R.string.whatNew);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            mAdapter = new RecentAdapter(getApplicationContext(), mListItem);
