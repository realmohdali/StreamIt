...
public class Offline extends AppCompatActivity implements RemoveDownloadedItem.SwipeToRemoveListener, RemoveQueueItem.SwipeToRemoveListener {

    private DownloadedAdapter downloadedAdapter;
    private SQLiteDatabase database;
    private RecyclerView downloadView;
    private RelativeLayout noDownloads;
